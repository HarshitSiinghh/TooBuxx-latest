...
const styles = StyleSheet.create({
  ...
  button: {
    marginTop: 16,
    backgroundColor: '#7c3aed', // Linear gradient fallback
    paddingVertical: 20,
    borderRadius: 16,
    alignItems: 'center',
    shadowColor: '#7c3aed',
...
// const styles = StyleSheet.create({
//   container: { flex: 1, backgroundColor: "#1a003d", padding: 24, justifyContent: "center" },
//   title: { color: "white", fontSize: 24, fontWeight: "700", marginBottom: 20 },
//   input: { backgroundColor: "#2f2360", borderRadius: 12, padding: 14, color: "white", marginBottom: 12 },
