  ...
  const loadWallet = async () => {
    try {
      ...
      if (wallet) {
        ...
        // ✅ TOTAL SAVINGS = total_wealth
        setTotalSavings(Number(wallet.total_wealth || 0));
      }
    } catch (e) {
        ...
        <View style={styles.liveTagRow}>
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            {/* <MaterialCommunityIcons
              ...
              style={{ marginLeft: 4 }}
            /> */}
            <MaterialCommunityIcons name="star" size={16} color="gold"    style={{ marginLeft: 4 }} />
          </View>
...
/>
      ...
      <View style={styles.actionButtonsRow}>
        <Pressable
          ...
          onPress={() => router.push("/paymentsDetails/deposite")}
        >
          <Text style={styles.btnTextLight}>DEPOSIT</Text>
        </Pressable>
